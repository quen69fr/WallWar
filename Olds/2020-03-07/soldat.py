...
class Soldat(Personne):
    ...
    def get_value_param(self, param):
        if param == PARAM_A_TIREUR_FORCE_TIR:
        ...
        elif param == PARAM_F_TIREUR_TYPE_EXPLOSION_TIR:
            return self.tireur.type_explosion_tir
        elif param == PARAM_F_TIREUR_EXPLOSION_TIR_DISTANCE:
            return self.tireur.type_explosion_tir
        return Personne.get_value_param(self, param)

    def set_value_a_param(self, param, val):
        if param == PARAM_A_TIREUR_FORCE_TIR:
            self.tireur.force_tir = val
            return True
        elif param == PARAM_A_TIREUR_PORTEE_TIR:
            self.tireur.portee_tir = val
            return True
        elif param == PARAM_A_TIREUR_DELAY_TIR:
            self.tireur.delay_tir = val
            return True
