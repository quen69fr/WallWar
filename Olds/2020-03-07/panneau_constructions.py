...
def vignette_batiment_panneau_construction(type_batiment, x: int, y: int, largeur: int, hauteur: int):
    ...
    return Vignette(type_batiment, x, y, largeur, hauteur, illustration, DIC_ELEMENTS[PARAM_F_NOM][type_batiment],
                    DIC_ELEMENTS[PARAM_F_BATIMENT_PERSONNE_PRIX_ARGENT_CONSTRUCTION][type_batiment],
                    DIC_ELEMENTS[PARAM_F_BATIMENT_PERSONNE_PRIX_LIQUIDE_CONSTRUCTION][type_batiment],
