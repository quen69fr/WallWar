...
def illustration_batiment(type_batiment, dimention_illustation: (int, int), cote_case: int):
    ...
    for i, j in DIC_ELEMENTS[PARAM_F_BATIMENT_LISTE_CASES][type_batiment][TYPE_CASE_S_DEPOS]:
    ...
    for i, j in DIC_ELEMENTS[PARAM_F_BATIMENT_LISTE_CASES][type_batiment][TYPE_CASE_S_RELAIS]:
        draw_filled_rect(ecran_illustration, (x_centre_cases + i * cote_case,
                                              y_centre_cases + j * cote_case, cote_case, cote_case),
                         DIC_CASES_SPECIALES[PARAM_CASE_S_COULEUR][TYPE_CASE_S_RELAIS])
    for n, (i, j) in enumerate(DIC_ELEMENTS[PARAM_F_BATIMENT_LISTE_CASES][type_batiment][TYPE_CASE_PLEINE]):
        draw_filled_rect(ecran_illustration, (x_centre_cases + i * cote_case,
                                              y_centre_cases + j * cote_case, cote_case, cote_case),
                         DIC_ELEMENTS[PARAM_F_BATIMENT_LISTE_COULEURS_CASES_PLEINES][type_batiment][n])
...
def illustration_element_mobile(type_element_mobile, dimention_illustation: (int, int), marge: int):
    ...
    image_oribinale = loaded_images(DIC_ELEMENTS[PARAM_F_ELEMENT_MOBILE_CHEMIN_IMAGE][type_element_mobile])
