...
class TireurEnnemi(Tireur):
    ...
    def __init__(self, force_tir, portee_tir, delay_tir):
    ...
    def rate_degas_destructions(self):
        return self.nb_degas_non_tireur * COEF_NOTE_ENNEMI_DEGAS_BATIMENT + \
               self.nb_degas_batiment * COEF_NOTE_ENNEMI_DEGAS_ELEMENT_MOBILE + \
